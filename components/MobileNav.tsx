...
const MobileNav: React.FC<MobileNavProps> = ({ currentView, onChangeView }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 z-50 pb-safe px-2 py-2 shadow-lg print:hidden transition-colors duration-200">
            ...
            >
              ...
              <div className={`px-4 py-1 rounded-full transition-all duration-300 ease-out flex items-center justify-center ${
                isActive 
                  ...
                  : 'bg-transparent text-slate-400 dark:text-slate-500 group-hover:bg-slate-100 dark:group-hover:bg-slate-800'
              }`}>
